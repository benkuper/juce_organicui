...
void CommentUI::mouseDrag(const MouseEvent& e)
{
	...
	else
	{
		...
		if (e.eventComponent == &resizer)
		{
			ItemMinimalUIListeners.call(&ItemMinimalUI<CommentItem>::ItemMinimalUIListener::baseItemUIResizeDrag, this, e.getOffsetFromDragStart());
		}
	}
}
...
void CommentUI::mouseUp(const MouseEvent& e)
{
	...
	if (e.eventComponent == &resizer)
	{
		ItemMinimalUIListeners.call(&ItemMinimalUI<CommentItem>::ItemMinimalUIListener::baseItemUIResizeEnd, this);
	}
}
