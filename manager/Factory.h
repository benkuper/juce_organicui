...
public:
	...
	template<class S>
	static FactorySimpleParametricDefinition* createDef(StringRef menu, var params = new DynamicObject())
	{
		return createDef(menu, S::getTypeStringStatic(), &FactorySimpleParametricDefinition<T>::createTemplated<S>, params);
	}
