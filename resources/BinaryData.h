...
namespace OrganicUIBinaryData
{
    ...
    extern const char*   drag_png;
    const int            drag_pngSize = 604;

    extern const char*   duplicate_png;
    const int            duplicate_pngSize = 2770;
    ...
    extern const char*   pin_png;
    const int            pin_pngSize = 645;
