...
String StringUtil::toShortName(const String& niceName, bool replaceSlashes) {
	...
	res = res.replaceCharacter('�', 'e').replaceCharacter('�', 'e').replaceCharacter('�', 'e')
		.replaceCharacter('�', 'a').replaceCharacter('�', 'a').replaceCharacter('�', 'o')
		.replaceCharacter('�', 'u').replaceCharacter('�', 'c');
