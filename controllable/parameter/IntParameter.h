...
{
public:
    IntParameter(const String &niceName, const String &description, const int &initialValue, const int &minimumValue = -INT_MIN, const int &maximumValue = INT_MAX, bool enabled = true);
    ~IntParameter() {}
